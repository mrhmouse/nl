  ...
  #+BEGIN_SRC c
    ...
    NL_BUILTIN(call) {
      ...
      case NL_PAIR:
        ...
        letq_tag = nl_cell_as_pair(nl_cell_as_pair(nl_cell_as_nil(), nl_cell_as_nil()), head.value.as_pair[1]);
        ...
        case NL_SYMBOL:
          vars->value.as_pair[0] = head.value.as_pair[0];
          vars->value.as_pair[1] = nl_cell_as_pair(nl_cell_as_pair(nl_cell_as_symbol("quote"), cell.value.as_pair[1]),
                                                   nl_cell_as_nil());
          return nl_letq(state, letq_tag, result);
        default:
    ...
    NL_BUILTIN(equal) {
      ...
      if (cell.type != NL_PAIR) {
        state->last_err = "illegal equal: non-pair args";
        return 1;
      }
